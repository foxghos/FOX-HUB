...
while wait() do
    for i,v in pairs(game:GetService("Workspace")["_WorldOrigin"]:GetChildren()) do
        pcall(function()
            if v.Name == ("CurvedRing") or v.Name == ("FoxGhostshHit") or v.Name == ("SwordFoxGhostsh") or v.Name == ("FoxGhostshTail") or v.Name == ("Sounds") then
                v:Destroy()
            end
        end)
    end
...
local Window = OrionLib:MakeWindow({Name = "FoxGhost Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "FoxGhost Hub"})

OrionLib:MakeNotification({
	Name = "FoxGhost Hub",
	Content = "Choose Teams Bro?",
	Image = "rbxassetid://126354860716520",
	Time = 7
})

OrionLib:MakeNotification({
	Name = "FoxGhost Hub",
	Content = "FoxGhost Hub",
	Image = "rbxassetid://126354860716520",
	Time = 25
})
...
local W = Window:MakeTab({
    Name = "Welcome",
    Icon = "rbxassetid://126354860716520",
    PremiumOnly = false
})
...
W:AddLabel("[+] FoxGhost Hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "FoxGhost Hub(Noitification)",
                            ...
                            if game:GetService("Workspace").NPCs:FindFirstChild("Skeleton Machine") then
                                ...
                                if game:GetService("Workspace").Map["Haunted Castle"].Candle1.Transparency == 0 then
                                    ...
                                    elseif game:GetService("Workspace").Map["Haunted Castle"].Tablet.Segment1:FindFirstChild("ClickDetector") then
                                        ...
                                        if game:GetService("Workspace").NPCs:FindFirstChild("FoxGhost") then
                                            local args = {
